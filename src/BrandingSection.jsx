...
const logos = [
  {bg:'#1C2D44',stroke:'#BCD4E8',nombre:'Logo principal',desc:'Fondo oscuro · Versión principal',radius:14},
  {bg:'#FAF7F2',stroke:'#1C2D44',nombre:'Logo claro',desc:'Fondo blanco · Para documentos',border:true,radius:14},
  {bg:'#1C2D44',stroke:'#BCD4E8',nombre:'Avatar circular',desc:'Perfil · RRSS · Favicon',radius:'50%'},
]
    ...
    <div>
      <div className="page-header">
        ...
        <div className="page-actions">
          <button className="btn-ghost">Editar identidad</button>
      ...
      <div style={{background:'#1C2D44',borderRadius:14,padding:'20px 28px',marginBottom:18,display:'flex',alignItems:'center',gap:24,flexWrap:'wrap'}}>
        ...
        <div style={{flex:1,minWidth:200}}>
          ...
          <div style={{fontSize:'0.76rem',color:'rgba(250,247,242,0.6)'}}>Fraunces + DM Sans comunica autoridad con calidez — ideal para tu target pyme premium. Consistencia alta en todos los canales analizados.</div>
        </div>
        <button style={{padding:'9px 18px',background:'#BCD4E8',border:'none',borderRadius:9,fontFamily:'var(--sans)',fontSize:'0.82rem',fontWeight:500,color:'#1C2D44',cursor:'pointer',whiteSpace:'nowrap',flexShrink:0}}>Editar identidad →</button>
      </div>
      ...
      <div className="dia-grid">
        ...
        <div className="dia-card">
          ...
          <div style={{display:'flex',flexDirection:'column',gap:10}}>
            ...
            <button className="btn-ghost" style={{width:'100%',marginTop:4}}>Editar paleta</button>
          </div>
        </div>
        ...
        <div className="dia-card">
          ...
          <div style={{display:'flex',flexDirection:'column',gap:14}}>
            ...
            <button className="btn-ghost" style={{width:'100%'}}>Editar tipografía</button>
          </div>
        </div>
        ...
        <div className="dia-card" style={{gridColumn:'1/-1'}}>
          ...
          <div style={{display:'flex',gap:10,marginTop:16,flexWrap:'wrap'}}>
            <button className="btn-ghost" style={{flex:1}}>Subir nuevo logo</button>
        ...
        <div className="dia-card">
          ...
          <div style={{display:'flex',flexDirection:'column',gap:8}}>
            ...
            <button className="btn-ghost" style={{width:'100%',marginTop:4}}>Editar guía de voz</button>
          </div>
        </div>
