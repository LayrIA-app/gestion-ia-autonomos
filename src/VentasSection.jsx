    ...
    <div>
      <div className="page-header">
        ...
        <div className="page-actions">
          ...
          <button className="btn-primary">Ir a Facturas →</button>
        </div>
      </div>
      ...
      <div className="dia-grid">
        <div className="dia-card" style={{gridColumn:'1/-1',background:'rgba(46,90,140,0.03)',border:'0.5px solid rgba(46,90,140,0.12)'}}>
          <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',flexWrap:'wrap',gap:12}}>
            ...
            <button style={{padding:'9px 18px',background:'#1C2D44',border:'none',borderRadius:9,fontFamily:'var(--sans)',fontSize:'0.82rem',fontWeight:500,color:'#FAF7F2',cursor:'pointer',whiteSpace:'nowrap'}}>Ver Facturas emitidas →</button>
          </div>
        </div>
